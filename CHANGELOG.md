...
### Tests
- **594 → 645 tests** — functional regression suite for the 2026-08-16 audit (extract-real-function + mock pattern), covering storage float %, MySQL replication password, timemachine unbound vars, entity decode, task window filter, integrity/drift deletion, sidecar clearing, portable date, max-time cap, alert queue retry, and dead-code guards. Coverage note added documenting functional vs grep-only coverage.
## [1.2.0] — 2026-08-05
